...
# FRC Team 4607 "Power Play" (2026 Season)
# ============================================================================
#
...
# Grab the token for .env (skip if already loaded from .env)
...
# Only restart if the service files actually changed, to avoid unnecessary downtime
if ! systemctl is-active --quiet robot-telemetry.service; then
    systemctl start robot-telemetry.service
fi
if ! systemctl is-active --quiet upload-server.service; then
